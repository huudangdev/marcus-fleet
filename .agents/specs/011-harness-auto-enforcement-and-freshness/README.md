# Harness Auto Enforcement and Freshness
...
7. Do not begin execution until:
   - `python3 .agents/scripts/validate_specs.py --feature .agents/specs/011-harness-auto-enforcement-and-freshness` passes
   - `python3 .agents/scripts/validate_execution_readiness.py --root . --feature .agents/specs/011-harness-auto-enforcement-and-freshness` passes
