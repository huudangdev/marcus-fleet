# Agent Routing: Harness Auto Enforcement and Freshness
...
| Harness implementation | `marcus-ai-orchestrator` | `alan-tech-lead`, `knowledge-work-architecture` | `scripts/*.py`, `scripts/check_repo_setup.sh`, README/USAGE/workflows | additive orchestration and freshness enforcement |
