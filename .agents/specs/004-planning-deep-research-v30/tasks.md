...
- Group A: `T002`, `T003` are parallel-safe once the shared scope assumptions are stable because their write scopes are disjoint.
- Group B: `T001`, `T004` close the loop after the implementation artifacts and validation evidence exist.
