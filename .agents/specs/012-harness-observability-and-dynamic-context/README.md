# Harness Observability and Dynamic Context
...
7. Do not begin execution until:
   - `python3 .agents/scripts/validate_specs.py --feature .agents/specs/012-harness-observability-and-dynamic-context` passes
   - `python3 .agents/scripts/validate_execution_readiness.py --root . --feature .agents/specs/012-harness-observability-and-dynamic-context` passes
