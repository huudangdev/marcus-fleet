# Marcus Init Output Contract Hardening
...
7. Do not begin execution until:
   - `python3 .agents/scripts/validate_specs.py --feature .agents/specs/015-marcus-init-output-contract-hardening` passes
   - `python3 .agents/scripts/validate_execution_readiness.py --root . --feature .agents/specs/015-marcus-init-output-contract-hardening` passes
