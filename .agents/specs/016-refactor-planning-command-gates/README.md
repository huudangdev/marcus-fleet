# Refactor Planning Command Gates
...
7. Do not begin execution until:
   - `python3 .agents/scripts/validate_specs.py --feature .agents/specs/016-refactor-planning-command-gates` passes
   - `python3 .agents/scripts/validate_execution_readiness.py --root . --feature .agents/specs/016-refactor-planning-command-gates` passes
